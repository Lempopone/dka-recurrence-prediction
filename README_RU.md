...
- [подробное описание feature engineering, анализа данных и пайплайна предобработки](src/eda/README_eda_RU.md) 
- [логика инференса модели, слой клинической интерпретации и архитектура сервиса](src/README_inference_RU.md)  
